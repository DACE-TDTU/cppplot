/**
 * @file benchmark_qp_solvers_V6.cpp
 ...
 *
 * Compile:
 *   g++ -std=c++17 -O2 -I../include benchmark_qp_solvers_V6.cpp -o bench_qp
 *   g++ -std=c++17 -O3 -I../include benchmark_qp_solvers_V6.cpp -o bench_qp  # timing
 *
...
int main() {
  ...
  std::cout
      << "\n╔══════════════════════════════════════════════════════════╗\n"
      << "║   DCAS QP Solver Benchmark — C++ + CppPlot  [V6]        ║\n"
